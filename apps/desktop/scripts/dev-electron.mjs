...
// oxlint-disable-next-line stofloos/no-global-process-runtime -- Standalone dev script has no Effect runtime.
...
function cleanupStaleDevApps() {
  ...
  NodeChildProcess.spawnSync("pkill", ["-f", "--", `--stofloos-dev-root=${desktopDir}`], {
    stdio: "ignore",
  });
}
...
function startApp() {
  ...
  const launchArgs = devProtocolClient
    ? electronArgs
    : [...electronArgs, `--stofloos-dev-root=${desktopDir}`, "dist-electron/main.cjs"];
